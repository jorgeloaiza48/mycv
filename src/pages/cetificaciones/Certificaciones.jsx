        ...
        <div>
            ...
            <h2 className='mt-5 text-center'>Certificaciones</h2>
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div><img src="./iconos/OracleDataScience.png" className="mx-auto d-block img-fluid" alt='' /></div>
                </div>
           
            <div><img src="./iconos/OracleAutonomousDatabase.png" className="mx-auto d-block img-fluid" alt='' /></div>
